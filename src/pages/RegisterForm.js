...
export default function RegisterForm() {
    ...
    return (
        <div className="container py-5">
            <h1 className="head p-3 bg-opacity-10 bg-danger">Registration</h1>
            <FontAwesomeIcon className="h-icon" icon={faRegistered}/>
                ...
                <form onSubmit={(e) => submitRegisterData(e)}>
                    ...
                    <div className="mb-3">
                        ...
                        <div className="passWord">
                            ...
                            />
                            <p>
                                <FontAwesomeIcon className="eye-icon" icon={faEye} onClick={togglePassword} />
                            </p>
                        </div>
